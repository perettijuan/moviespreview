...
"""Undelete command for the Label Manager - Label Keys CLI."""
...
class Undelete(base.Command):
  """Undeletes the specified LabelKey resource.
  ...
  def Run(self, args):
    ...
    undelete_request = labelmanager_messages.LabelmanagerLabelKeysUndeleteRequest(
        name=label_key)
