...
try:
  ...
  six.raise_from(
      ImportError('gRPC is not installed, please install the grpcio package '
...
class AuthMetadataPlugin(grpc.AuthMetadataPlugin):
  ...
  def _get_authorization_headers(self, context):
    """Gets the authorization headers for a request.
        ...
        """
    headers = {}
    self._credentials.before_request(self._request, context.method_name,
                                     context.service_url, headers)
  ...
  """Creates a secure authorized gRPC channel.
    ...
    Args:
        credentials (google.auth.credentials.Credentials): The credentials to
          add to requests.
        request (google.auth.transport.Request): A HTTP transport request object
          used to refresh credentials as needed. Even though gRPC is a separate
          transport, there's no way to refresh the credentials without using a
