...
class Credentials(credentials.ReadOnlyScoped, credentials.Credentials):
  ...
  def __init__(self,
    ...
    """
        Args:
            token (Optional(str)): The OAuth 2.0 access token. Can be None if
              refresh information is provided.
            refresh_token (str): The OAuth 2.0 refresh token. If specified,
              credentials can be refreshed.
            id_token (str): The Open ID Connect ID Token.
            token_uri (str): The OAuth 2.0 authorization server's token endpoint
              URI. Must be specified for refresh, can be left as None if the
            ...
            client_secret(str): The OAuth 2.0 client secret. Must be specified
              ...
              refreshed.
            scopes (Sequence[str]): The scopes that were originally used to
              obtain authorization. This is a purely informative parameter
