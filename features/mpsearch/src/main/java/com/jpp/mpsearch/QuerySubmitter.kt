...
/**
 * [SearchView.OnQueryTextListener] implementation to handle the user searchPage over the
 ...
 */
class QuerySubmitter(private val callback: (String) -> Unit) : SearchView.OnQueryTextListener {
