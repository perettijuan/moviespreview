...
class PopularMoviesFragment : MoviesFragment() {
    ...
    class PopularMoviesFragmentViewModel @Inject constructor(movieListRepository: MovieListRepository, mapper: MovieItemMapper)
        : MoviesFragmentViewModel(movieListRepository, mapper, MovieSection.Popular)
}